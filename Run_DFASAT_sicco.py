...
def main():
    ...
    write_to_file_in_new_line(statistic_file_path, f"Size of training positive walks: {len(training_pos_walks)}\n"
                              f"Size of training negative walks: {len(training_neg_walks)}\n")
    # Build APTA
    apta = Tree()
    ...
    graph_to_dot(edsm.pta.G,f'{directory}/{filename}_{trails}_{walks_size}_{learning_strategy}_siccoEDSM.dot')
