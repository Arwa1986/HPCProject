...
def main():
    ...
    classical_edsm.setup(f'{directory}/{filename}_{trails}_{walks_size}_{learning_strategy}_mergeTracker.txt')
    ...
    graph_to_dot(classical_edsm.pta.G,f'{directory}/{filename}_{trails}_{walks_size}_{learning_strategy}.dot')
