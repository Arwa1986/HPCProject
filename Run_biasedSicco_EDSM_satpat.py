...
def main():
    ...
    save_Exploration_map_to_file(edsm.hard_patterns, f'{directory}/{args.filename}_{trails}_{walks_size}_{learning_strategy}_hard_map.txt')
    save_Exploration_map_to_file(edsm.soft_patterns, f'{directory}/{args.filename}_{trails}_{walks_size}_{learning_strategy}_soft_map.txt')
    ...
    edsm.write_statistics(f'{directory}/{filename}_{trails}_{walks_size}_{learning_strategy}_statistics.txt')
    write_to_file_in_new_line(f'{directory}/{filename}_{trails}_{walks_size}_{learning_strategy}_statistics.txt',
    ...
    dfasat_graph = sat_solver.run_dfasat_with_patterns(f'{directory}/{filename}_{trails}_{walks_size}_{learning_strategy}', edsm.hard_patterns)
